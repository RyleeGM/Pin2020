...
{	
	...
	{
		//4 register writes
		INS_InsertCall(ins, IPOINT_BEFORE, (AFUNPTR)Reg3W, IARG_UINT32, INS_RegR(ins, 0), IARG_UINT32, INS_RegR(ins, 1), IARG_UINT32, INS_RegR(ins, 2), IARG_UINT32, INS_RegR(ins, 3), IARG_END);
	}
}
